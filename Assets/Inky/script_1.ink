=== INTRO_CUTSCENE ===
- \(depois de muito tempo, voces chegam.\)
-> END
...
=== FAIRY_STATUE ===
{ cycle: 
- "Em homenagem a SANTA FADA, defensora do bosque."
- "Que suas asas nos protejam e suas aguas nos eluminem."
}
-> END
...
=== KOROK_VEGETARIAN ===
{ stopping:
- tem gente que come planta. vc nao acha isso um absurdo?
- NOS somos plantas. vc ME COMERIA? (eh uma pergunta retorica nao responda...) 
- eu venho aqui todo dia olhar as plantas... sentir minha ligacao com elas...
- sentir o cheiro delas... o gosto...
- ahn, sera que vc pode me deixar sozinha...
}
-> END

=== KOROK_MOLERAT ===
{ stopping:
- oi! vc ja viu as toupeiras?
...
=== MAN_CUTTING_TREE ===
{ stopping:
- FALA PRA MIM. JA VIU UMA ARVORE QUE CRESCE EM 1 NOITE?
- POIS TODO DIA DE MANHA APARECE UMA ARVORE NOVA AQUI POR PERTO.
- ESTOU COMECANDO A ACHAR QUE AQUELAS ARVORES IRRITANTES ESTAO PREGANDO UMA PECA EM MIM
- ELES NAO TEM NOCAO DO PERIGO QUE EH TER UMA ARVORE DESSAS PERTO DA MINA?
- OU TALVEZ ELES SAIBAM MUITO BEM O QUE ESTAO FAZENDO...
- MALDITAS ARVORES AAAAAAAAAAAAAA
}
-> END
